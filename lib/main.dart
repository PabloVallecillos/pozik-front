...
import 'package:pozik_front/firebase_options.dart';
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Text(AppLocalizations.of(context).password.capitalize(), style: const TextStyle(color: Colors.black),),
            Text(
              '$_counter',
